...
public class BoardController {
	...
	@GetMapping("/list")
	public String boardList(Model model, @RequestParam(defaultValue = "1") int cpage, SearchDto searchDto) {
		// TODO: 페이징 처리
	...
	@PostMapping("/delete")
	public String boardDelete(@RequestParam(required = true) int bno, HttpSession session, Model model) {
	...
	@PostMapping("/update")
	public ModelAndView updateBoard(HttpSession session, Board board, ModelAndView mv, MultipartFile upfile){
