...
public class MemberController {
	...
	public void searchById(String searchId) {
		ArrayList <Member> list = mService.searchById(searchId);
	...
	public void updateMember(String id, String pwd, String gender, String addr, String hobby) {
		...
		*/
		...
		int result = mService.updateMember(m);	// DML(Update) ---> int(처리된 행 수)
	...
	public void deleteMember(String id) {
		int result = mService.deleteMember(id); // DML(delete) ---> int (처리된 행 수)
